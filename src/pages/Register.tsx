    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 bg-[#2d2d2d] font-body antialiased text-white h-screen relative">
      ...
      <div className="flex items-center justify-center py-12 px-6 lg:px-8 bg-[#2d2d2d] order-last lg:order-first">
        <div className="w-full max-w-md bg-[#3a3a3a] p-10 rounded-[24px] shadow-[0_25px_60px_rgba(0,0,0,0.3)] border border-white/5">
          ...
          <div className="text-center mb-8">
            <h2 className="text-lg font-bold tracking-tight text-white">Selamat Datang di F-Tech Solution</h2>
            <p className="mt-1 text-xs text-gray-400 font-normal">Daftar untuk mulai mengelola portofolio keberlanjutan Anda</p>
            <h3 className="text-xl font-bold text-white mt-6 tracking-wide">Registrasi</h3>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-gray-400">
            ...
            <button type="button" onClick={() => navigate("login")} className="text-[#e05c2a] font-bold hover:underline bg-transparent cursor-pointer ml-0.5">
              Login di sini
            </button>
          </p>
      ...
      >
        ...
        <div className="relative z-10 max-w-md mb-8">
          <h1 className="font-head text-3xl md:text-4xl font-black text-white italic leading-tight mb-4">"Satu Langkah Kecil, Dampak Besar Berkelanjutan."</h1>
          <p className="text-gray-300 text-sm leading-relaxed">Bergabung bersama ribuan pelaku usaha yang mengedepankan transparansi lingkungan berbasis standarisasi ESG dan teknologi ramah bumi.</p>
        </div>
      </div>
    </div>
  );
