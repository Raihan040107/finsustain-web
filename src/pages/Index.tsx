      ...
      <section className="w-full bg-white/[0.03] border-t border-b border-white/[0.08] py-10 md:py-12">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center space-y-1">
            ...
            <div className="text-[0.82rem] md:text-[0.88rem] text-[#b0a89e] font-medium uppercase tracking-wider">
              Dana Tersalurkan Global
            </div>
          </div>
          <div className="text-center space-y-1">
            <div className="font-head text-3xl md:text-[2.5rem] font-black text-[#e05c2a] leading-normal tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[0.98rem] text-[#b0a89e] leading-[1.75]">
              Kami menggabungkan data laporan keuangan konvensional dengan matriks audit kelayakan karbon modern untuk menciptakan gerbang investasi berisiko rendah yang transparan bagi penyedia dana internasional.
            </p>
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-[20px] overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <span className="inline-flex items-center gap-2 bg-[#4caf50]/10 border border-[#4caf50]/20 rounded-full px-4 py-1.5 text-[0.8rem] font-semibold text-[#81c784] w-fit">✓ Pendanaan Cair Rp850 Juta</span>
                <span className="inline-flex items-center gap-2 bg-[#4caf50]/10 border border-[#4caf50]/20 rounded-full px-4 py-1.5 text-[0.8rem] font-semibold text-[#81c784] w-fit">✓ Hemat Biaya Listrik Operasional 35%</span>
              </div>
            </div>
          </div>
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-[20px] overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <span className="inline-flex items-center gap-2 bg-[#4caf50]/10 border border-[#4caf50]/20 rounded-full px-4 py-1.5 text-[0.8rem] font-semibold text-[#81c784] w-fit">✓ Kredit Sindikasi Rp4.2 Miliar</span>
                <span className="inline-flex items-center gap-2 bg-[#4caf50]/10 border border-[#4caf50]/20 rounded-full px-4 py-1.5 text-[0.8rem] font-semibold text-[#81c784] w-fit">✓ 240 Ton Sampah Berhasil Didaur Ulang</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#2196f3]/[0.05] border border-white/[0.08] rounded-[20px] p-8 relative overflow-hidden before:absolute before:top-0 before:left-0 before:right-0 before:h-1 before:bg-[#2196f3] shadow-sm">
              ...
              <p className="text-[0.88rem] text-[#b0a89e] leading-[1.65]">Membantu entitas komersial mencatatkan jejak hitungan jejak karbon harian guna mewujudkan aksi emisi Nol Bersih (Net Zero).</p>
            </div>
          </div>
        </div>
      </section>
