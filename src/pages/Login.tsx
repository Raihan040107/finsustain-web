...
export default function Login({ navigate }: { navigate: (page: PageName) => void }) {
        ...
        <div className="auth-card">
          <div className="auth-logo">
            ...
            <div>
              ...
              <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>Login to manage your sustainability</div>
            </div>
          </div>
          <h3>Login</h3>
          ...
          <button className="btn btn-primary btn-full" onClick={() => setShowModal(true)}>Login</button>
          <p style={{ marginTop: "16px", fontSize: "0.8rem", color: "var(--text-muted)" }}>
            Belum punya akun?{" "}
            <a href="#" style={{ color: "var(--accent)" }} onClick={(e) => { e.preventDefault(); navigate("register"); }}>Daftar sekarang</a>
          </p>
        </div>
      </div>
      <Modal
